package com.yimi.rentme.utils.water.util;
...
import com.yimi.rentme.utils.water.GPUImageFilter;
...
public class OpenGlUtils {
    ...
    public static String readShaderFromRawResource(final int resourceId) {
        final InputStream inputStream = BaseApp.context.getResources().openRawResource(
                resourceId);
